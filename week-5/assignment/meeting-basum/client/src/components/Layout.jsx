...
function Layout() {
  // Context API: reads current user name and initials for the header avatar.
  // Theme from context is applied as a data-attribute so CSS can key off it.
  const { user } = useUser();
  ...
  return (
    <div className="layout-container" data-theme={user.theme}>
      {/* Sidebar */}
      ...
      <div className="main-area">
        {/* Header — shows user name/initials from Context */}
